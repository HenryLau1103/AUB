...
`init` 會建立 AUB 設定、GitHub issue templates、Copilot instructions 與 PR workflow。`aub-workspace` 會啟動本機 AUB MCP HTTP server、提供 bundled AUB editor、把 editor 連到 MCP endpoint，並開啟瀏覽器。
