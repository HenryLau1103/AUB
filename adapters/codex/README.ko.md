...
Codex 용 implement, plan, review prompt 를 생성합니다. Core Blueprint schema 는 변경하지 않습니다.
...
생성된 prompt 는 Codex 에게 적용 가능한 `AGENTS.md` 를 읽고, repository-native patterns 를 따르고, checks 를 실행하며, 각 acceptance id 의 evidence 를 보고하도록 지시합니다.
